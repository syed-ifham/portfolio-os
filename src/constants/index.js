...
//----------NAVBAR✅
export const navLinks = [{id: 1, title: "Projects", type: "finder", isOpen: false}, {
...
export const LOCATIONS = {
    ...
    finder: {
            ...
            id: 1, type: "work", name: "Work", icon: "/icons/work.png", kind: "folder", children: [//> project 1
                {
                    id: 101, name: "Cal AI", icon: "/icons/mac-folder.png", kind: "folder", position: {
                        top: 50, left: 300,
                    }, windowPosition: "top-[50vh] left-50", children: [{
                        id: 1010,
                ...
                //> project 2
                {
                    ...
                    }, windowPosition: "top-[20vh] left-40", children: [{
                        id: 1020,
                        name: "Project Name.txt",
                        icon: "/icons/file.png",
                        kind: "file",
                ...
                //> project 3
                {
                    ...
                    position: {
                        top: 150, left: 100, right: 0, bottom: 0,
                    },
                    children: [{
                        id: 1030,
                        name: "portfolio.com",
        ...
        ABOUT_LOCATION: {
            id: 2, type: "about", name: "About", icon: "/icons/info.png", kind: "folder", children: [{
                id: 201,
                name: "who am i",
                icon: "/icons/file.png",
                kind: "folder",
        ...
        RESUME_LOCATION: {
            id: 3, type: "resume", name: "Resume", icon: "/icons/file.png", kind: "folder", children: [// resume section
                {
                    id: 301,
                    type: "resume",
                    name: "resume.pdf",
        ...
        TRASH_LOCATION: {
            id: 4, type: "trash", name: "Trash", icon: "/icons/trash.png", kind: "folder", children: [//> project 1
                {
                    id: 401,
