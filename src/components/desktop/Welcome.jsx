...
const Welcome = () => {
    ...
    return (
        // <section className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center select-none z-0">
         <section className="fixed inset-0 flex items-center justify-center text-center select-none z-0">
